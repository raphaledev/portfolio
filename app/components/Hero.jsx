...
const Hero = () => {
    return (
        <div className="flex flex-col gap-8 min-h-screen place-content-end py-16">
            ...
            <div className="">
                <Image className="rounded-full border-white border-8" src='/avatar.jpg' alt="avatar" height={180} width={180}></Image> 
            </div>
            <h1 className="text-5xl font-bold">Hi, I’m <span className="text-red-500">Raphael Faye</span></h1>
